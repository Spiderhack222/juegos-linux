...
int main() {
    ...
    do {
        ...
        switch (opcion) {
            case 1:
                system("./buscaminas"); // Ejecutar buscaminas
                break;
            case 2:
                system("./gato"); // Ejecutar gato
                break;
            case 3:
                system("./piedra"); // Ejecutar piedra
                break;
            case 4:
                system("./laberinto/JuegoLaberintos"); // Ejecutar Juego de Laberintos desde la ruta especificada
                break;
            case 5:
